...
public class MainActivity extends ActionBarActivityView implements IMainMenuView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // this really probably needs to do some more than what I have listed right here
        IMainMenuController controller = new MainMenuController(this);
        setController(controller);

        //supposedly the asteroidsGame singleton is called from this function
        // but I don't do that...
    ...
    /**
     * I'm guessing that here is where I'm going to do dataImporting...
     */
